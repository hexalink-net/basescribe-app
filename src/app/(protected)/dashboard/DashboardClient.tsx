...
export default function DashboardClient({ user, userProfile, uploads, folders, currentFolder, encryptionData }: DashboardClientProps) {
  ...
  const handleBulkMove = async (folderId: string | null) => {
    ...
    try {
      ...
      // Close dialog and clear selection immediately for better UX
      setShowMoveDialog(false);
      ...
      toast({
        title: "Moving files...",
        description: `Moving ${selectedCount} file(s)`,
      });
      ...
      if (success) {
        ...
        toast({
          title: "Files moved",
          description: `${selectedCount} file(s) have been successfully moved.`,
        });
  ...
  // No need to memoize the header component anymore as we're using the DashboardHeader component
